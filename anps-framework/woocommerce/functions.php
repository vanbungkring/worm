<?php
	...
	function icl_post_languages() {
	  ...
	  if(1 < count($languages)){
	    echo __('This post is also available in:', "shopbox");
    ...
    register_sidebar(array(
        'name' => __('Filter', 'shopbox'),
        'id' => 'filter-widget-area',
        'description' => __('Filter widget area. Can only contain WooCommerce Price Filter and YITH WooCommerce Ajax Navigation widgets.', 'shopbox'),
    ...
    function order_status( $status ) {
		...
		?>
			<ul class="order-status">
				<li class="first"><a <?php if( $status == "myaccout" ) { echo 'class="current"'; } ?> href="<?php echo $myaccount_url; ?>"><?php echo _e("Sign in", "shopbox"); ?></a></li>
				<li><a <?php if( $status == "cart" ) { echo 'class="current"'; } ?> href="<?php echo $cart_url; ?>"><?php echo _e("Cart", "shopbox"); ?></a></li>
				<li><a <?php if( $status == "checkout" ) { echo 'class="current"'; } ?> href="<?php echo $checkout_url; ?>"><?php echo _e("Checkout", "shopbox"); ?></a></li>
				<li class="last"><a <?php if( $status == "thankyou" ) { echo 'class="current"'; } ?> href="<?php echo $payment_page; ?>"><?php echo _e("Order Complete", "shopbox"); ?></a></li>
			</ul>
		<?php
    }
    ...
    function myaccount_sidebar($page) { ?>
			...
			<div class="col-md-3 sidebar">
				...
				<h3><?php _e("My Account", "shopbox"); ?></h3>

				<ul class="myaccount-menu">
					<li class="widget-container widget_nav_menu">
						<div class="menu-main-menu-container">
							<ul class="menu">
								<li class="menu-item<?php if($page == "myaccount"){ echo " current-menu-item page_item current_page_item current_page_parent"; } ?>"><a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>"><?php _e("My Orders", "shopbox"); ?></a></li>
								<li class="menu-item<?php if($page == "wishlist"){ echo " current-menu-item page_item current_page_item current_page_parent"; } ?>"><a href="<?php echo get_permalink( get_option( 'yith_wcwl_wishlist_page_id' ) ); ?>"><?php _e("My Wishlist", "shopbox"); ?></a></li>
								<li class="menu-item<?php if($page == "address"){ echo " current-menu-item page_item current_page_item current_page_parent"; } ?>"><a href="<?php echo add_query_arg("subpage", "address", get_permalink( get_option( 'woocommerce_myaccount_page_id' ))); ?>"><?php _e("Address Book", "shopbox"); ?></a></li>
								<li class="menu-item<?php if($page == "change_account"){ echo " current-menu-item page_item current_page_item current_page_parent"; } ?>"><a href="<?php echo wc_customer_edit_account_url(); ?>"><?php _e("Change Account", "shopbox"); ?></a></li>
								<?php
								    if (is_user_logged_in()) {
								        echo '<li><a href="'. wp_logout_url( get_permalink( woocommerce_get_page_id( 'myaccount' ) ) ) .'">' . __("Logout", "shopbox") . '</a></li>';
								    }
								?>
							</ul>
						</div>				
