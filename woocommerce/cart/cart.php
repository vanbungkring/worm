				...
				<td colspan="6" class="actions">
					...
					<?php if ( $woocommerce->cart->coupons_enabled() ) { ?>
						<div class="coupon">
							...
							<label for="coupon_code"><?php _e( 'Coupon', 'woocommerce' ); ?>:</label> <input placeholder="<?php _e("Enter coupon code", "shopbox"); ?>" type="text" name="coupon_code" class="input-text" id="coupon_code" value="" /> <input type="submit" class="btn-style-1 btn-style-3" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
