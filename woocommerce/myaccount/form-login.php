...
<?php endif; ?>
	<h2><?php _e( 'Registered customers', 'shopbox' ); ?></h2>
...
<?php if (get_option('woocommerce_enable_myaccount_registration')=='yes') : ?>
	...
	<div class="col-md-4 woo-register-form">
		<h2><?php _e("Not registered?", "shopbox"); ?></h2>
		<div>
			<p><?php _e("Creating an account  is quick and easy, and will allow you to move through our checkout quicker.", "shopbox"); ?></p>
			<a class="btn btn-md btn-style-1 open-register-form" data-toggle="modal" href="#register-popup"><?php _e("Register", "shopbox"); ?></a>
		</div>
	</div>
				...
				<div class="modal-body">
					<form method="post" class="register">
						...
						<?php endif; ?>
							...
							<label for="reg_email"><?php _e( 'Email', 'shopbox' ); ?> <span class="required">*</span></label>
