<?php
/* CONSTANTS */
define('ANPS_TEMPLATE_LANG', 'move');
global $not_content;
/* Override vc tabs */
...
function anps_theme_styles() {     
    ...
    if ( get_option('font_source_1') && get_option('font_source_1')=='Google fonts') {
        wp_enqueue_style( "font_type_1",  'http://fonts.googleapis.com/css?family=' . get_option('font_type_1', 'Open+Sans') . ':400italic,400,600,700,300&subset=latin,latin-ext');
    } else {
    ...
    if ( get_option('font_source_2') && get_option('font_source_2')=='Google fonts') {
        wp_enqueue_style( "font_type_2",  'http://fonts.googleapis.com/css?family=' . get_option('font_type_2', 'Open+Sans') . ':400italic,400,600,700,300&subset=latin,latin-ext');
    }
    
    if ( get_option('font_source_3') && get_option('font_source_3')=='Google fonts') {
        wp_enqueue_style( "font_type_3",  'http://fonts.googleapis.com/css?family=' . get_option('font_type_3', 'Open+Sans') . ':400italic,400,600,700,300&subset=latin,latin-ext');
    }
...
load_theme_textdomain( 'move', get_template_directory() . '/languages' );
